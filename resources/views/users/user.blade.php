...
@section('content')
    ...
    @include('layouts/header')
            ...
            <!-- Modal User -->
            <div id="modal-user" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true">
                    ...
                    <div class="modal-content bg-default">
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="row no-gutters">       
                                <form action="{{ url('add/user/request') }}" method="POST" enctype="multipart/form-data" style="width: 100%; text-align: left !important;">
                                @csrf
                                <div class="card card-form">
