...
@section('content')
    ...
    @include('layouts/header')
            ...
            <form action="{{ url('change/order/status') }}" method="POST" style="width: 100%; margin-bottom: 20px;" class="d-print-none">
                @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <select class="form-control selectpicker-search mb-3" name="order_status">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 offset-md-2">
                                <div class="mt-3 float-md-right">
                                    ...
                                    <p><strong>Order Status : </strong> <span class="float-right"><span class="badge badge-dark">{{ ucwords($invoice->orderStatus->order_status_name) }}</span></span></p>
