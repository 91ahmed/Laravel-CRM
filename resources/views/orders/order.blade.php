...
@section('content')
    ...
    @include('layouts/header')
            ...
            <!-- Modal Activity -->
            <div id="modal-order" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content bg-default">
                        ...
                        <div class="modal-body text-center p-4">
                            <div class="row no-gutters">       
                                <form action="{{ url('add/order/request') }}" method="POST" enctype="multipart/form-data" style="width: 100%; text-align: left;">
                                    @csrf
                                    <div class="card card-form">
