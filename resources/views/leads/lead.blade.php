...
@section('content')
    ...
    @include('layouts/header')
            ...
            <!-- Modal User -->
            <div id="modal-lead" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content bg-default">
                        ...
                        <div class="row no-gutters">
                            <form action="{{ url('add/lead/request') }}" method="POST" enctype="multipart/form-data" style="width: 100%;">
                                @csrf
                                <div class="card card-form">
